                ...
                <li class="rating__list">
                    <span class="rating__list--icon">
                        <svg class="rating__list--icon__svg" xmlns="http://www.w3.org/2000/svg" width="14.105" height="14.732" viewBox="0 0 10.105 9.732">
                            <path data-name="star - Copy" d="M9.837,3.5,6.73,3.039,5.338.179a.335.335,0,0,0-.571,0L3.375,3.039.268,3.5a.3.3,0,0,0-.178.514L2.347,6.242,1.813a.314.314,0,0,0,.464.316L5.052,8.232,7.827,9.712A.314.314,0,0,0,8.292,9.4L7.758,6.242l2.257-2.231A.3.3,0,0,0,9.837,3.5Z" transform="translate(0 -0.018)" fill="{{ $i <= round($productData['average_rating']) ? 'currentColor' : 'none' }}" stroke="{{ $i <= round($productData['average_rating']) ? 'none' : 'currentColor' }}"></path>
                        </svg>
                    </span>
                </li>
            @endfor
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.variant__wishlist--icon').forEach(link => {
            ...
            function showMessage(message, type) {
                const messageContainer = document.querySelector('.product__details--info');
                ...
                // Auto-dismiss after 4 seconds (matching message.blade.php)
                setTimeout(() => {
