...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="attributes-table" width="100%">
                <thead>
                    <tr>
...
$(function() {
    ...
    $('#bulk-delete').on('click', function() {
        ...
        if (confirm('Are you sure you want to delete selected attributes?')) {
            $.ajax({
                url: "{{ route('admin.product-attributes.bulk-delete') }}",
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    ids: ids
