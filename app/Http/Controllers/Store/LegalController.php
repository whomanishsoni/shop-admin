    ...
    public function privacyPolicy()
    {
        $pageData = Page::where('slug', 'privacy-policy')
            ...
            ->first() ?? new Page([
                ...
                'meta_title' => 'Privacy Policy - Waseem Fashion Studio',
                'meta_description' => 'Learn more about Waseem Fashion Studio’s policies and procedures.'
            ]);
    ...
    public function termsConditions()
    {
        $pageData = Page::where('slug', 'terms-conditions')
            ...
            ->first() ?? new Page([
                ...
                'meta_title' => 'Terms & Conditions - Waseem Fashion Studio',
                'meta_description' => 'Learn more about Waseem Fashion Studio’s policies and procedures.'
            ]);
    ...
    public function refundPolicy()
    {
        $pageData = Page::where('slug', 'refund-policy')
            ...
            ->first() ?? new Page([
                ...
                'meta_title' => 'Refund Policy - Waseem Fashion Studio',
                'meta_description' => 'Learn more about Waseem Fashion Studio’s policies and procedures.'
            ]);
    ...
    public function shippingPolicy()
    {
        $pageData = Page::where('slug', 'shipping-policy')
            ...
            ->first() ?? new Page([
                ...
                'meta_title' => 'Shipping Policy - Waseem Fashion Studio',
                'meta_description' => 'Learn more about Waseem Fashion Studio’s policies and procedures.'
            ]);
