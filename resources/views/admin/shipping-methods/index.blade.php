...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="shipping-methods-table" width="100%">
                <thead>
                    <tr>
...
$(function() {
    var table = $('#shipping-methods-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.shipping-methods.index') }}",
        columns: [
    ...
    $('#bulk-delete').on('click', function() {
        ...
        if (confirm('Are you sure you want to delete selected items?')) {
            $.ajax({
                url: "{{ route('admin.shipping-methods.bulk-delete') }}",
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    ids: ids
