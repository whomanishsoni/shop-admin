...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <div class="d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Payment Gateways List</h6>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="payment-gateways-table" width="100%">
                <thead>
                    <tr>
...
<script>
$(function() {
    var table = $('#payment-gateways-table').DataTable({
        processing: true,
        serverSide: true,
    ...
    $('#bulk-delete').on('click', function() {
        ...
        if (confirm('Are you sure you want to delete selected items?')) {
            $.ajax({
                url: "{{ route('admin.payment-gateways.bulk-delete') }}",
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    ids: ids
