<!-- Updated newsletter-popup.blade.php -->
    ...
    <div id="boxes" class="newsletter__popup--inner">
        ...
        <div class="box newsletter__popup--box d-flex align-items-center">
            <div class="newsletter__popup--thumbnail">
                <img class="newsletter__popup--thumbnail__img display-block" src="{{ asset('assets/images/newsletter-popup-thumb2.png') }}" alt="newsletter-popup-thumb">
            </div>
