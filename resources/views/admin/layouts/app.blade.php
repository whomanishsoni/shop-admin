...
<head>
    ...
    <title>@yield('title', 'Waseem Fashion Studio Admin Panel')</title>
    ...
    <style>
        ...
        .nav-link:not(.collapsed) .collapse-arrow {
...
<body id="page-top">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Handle accordion collapse behavior with arrow icons
            const accordionLinks = document.querySelectorAll('.nav-link[data-bs-toggle="collapse"]');
